...
import 'package:api_client/src/api/analytics_api.dart';
import 'package:api_client/src/api/auth_api.dart';
import 'package:api_client/src/api/favorites_api.dart';
import 'package:api_client/src/api/ratings_api.dart';
import 'package:api_client/src/api/recipes_api.dart';
import 'package:api_client/src/api/shopping_lists_api.dart';
...
class ApiClient {
  ...
  /// Get ShoppingListsApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  ShoppingListsApi getShoppingListsApi() {
    return ShoppingListsApi(dio, serializers);
  }
