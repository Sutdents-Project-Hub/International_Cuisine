...
class AnalyticsApi {
  ...
  Future<Response<void>> analyticsControllerGetStats({ 
    ...
    final _path = r'/api/v1/analytics/stats';
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> analyticsControllerTrackEvent({ 
    ...
    final _path = r'/api/v1/analytics/events';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
